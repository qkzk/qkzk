...
- [sqlite](https://www.sqlite.org/index.html) implémente une bdd SQL stockée dans des fichiers. Très pratique et facile d'accès.
...
- Depuis 2019, le contenu est tapé en en [markdown](https://fr.wikipedia.org/wiki/Markdown) et le site est crée avec [HUGO](https://gohugo.io/). Le thème est [hugo-book](https://themes.gohugo.io/hugo-book/). Il est hébergé sur une [github page](https://pages.github.com/) et le nom de domaine est réservé par Hostinger. Seul le nom de domaine est payant (pas le choix), les autres outils sont gratuits.
